...
public class MyAboutTab1Controller extends TabController {
    View view;
    ListView myabout_lv;
    ...
    public MyAboutTab1Controller(Context context) {
        super(context);
    }
    ...
    protected View initContentView(Context context) {
        mContext = context;
        view = View.inflate(context, R.layout.myabouttab1_control, null);
        return view;
    }
    ...
    public void getList(String name) {
        ...
        Log.i("xiaopeng", "url----:" + MouthpieceUrl.base_mind_friendList + "?" + params.getQueryStringParams().toString().replace(",", "&").replace("[", "").replace("]", "").replace(" ", ""));
        new HttpGet<GsonObjModel<List<XinShi>>>(MouthpieceUrl.base_mind_friendList , mContext, params) {
            @Override
