...
public class HttpGet<T> extends RequestCallBack<String> {
    ...
    public HttpGet(String URL, Context context, RequestParams params) {
        mUrl = URL;
        mContext = context;
        mParams = params;
        onInit();
...
//                response.code = 500;
//                response.message = "数据转换错误" + e1.getMessage();
            }
