...
public class MyAboutTab2Controller extends TabController {
    View view;
    ListView myabout_lv;
    ...
    public MyAboutTab2Controller(Context context) {
        super(context);
    }
    ...
    protected View initContentView(Context context) {
        mContext = context;
        view = View.inflate(context, R.layout.myabouttab2_control, null);
        return view;
    }
