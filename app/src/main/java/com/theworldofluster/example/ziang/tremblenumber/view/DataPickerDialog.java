...
public class DataPickerDialog extends Dialog {
    ...
    public void setSelection(String itemValue) {
        if (params.dataList.size() > 0) {
            ...
            if (idx >= 0) {
                ...
                params.loopData.setCurrentPosition(params.initSelection);
            }
        }
    }
    ...
    public static class Builder {
        ...
        private final int getCurrDateValue() {
            return params.loopData.getSelectedItem();
        }
        ...
        public DataPickerDialog create() {
            ...
            loopData.setItems(params.dataList);
            loopData.setNotLoop();
            loopData.setTextSize(15);
            if (params.dataList.size() > 0) loopData.setCurrentPosition(params.initSelection);
